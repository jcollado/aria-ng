...
def get_template_interfaces(context, presentation, type_name):
    ...
    interface_definitions = the_type._get_interfaces(context) if the_type is not None else None # InterfaceDefinition (or InterfaceAssignment in the case of RelationshipTemplate)
    ...
    if our_interface_assignments:
        for interface_name, our_interface_assignment in our_interface_assignments.iteritems(): # InterfaceAssignment
            if interface_name in template_interfaces:
                ...
                interface_definition = interface_definitions[interface_name] # InterfaceDefinition (or InterfaceAssignment in the case of RelationshipTemplate)
