...
@dsl_specification('8.2.2', 'tosca-simple-nfv-1.0')
...
@has_validated_properties
@dsl_specification('8.2.3', 'tosca-simple-nfv-1.0')
...
@has_validated_properties
@dsl_specification('10.3.1', 'tosca-simple-nfv-1.0')
...
@has_validated_properties
@dsl_specification('11.3.1', 'tosca-simple-nfv-1.0')
